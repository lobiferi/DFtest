 ...
 */
class Application_Model_Details extends \Application_Model_Details implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application_Model_Details' . "\0" . 'id', '' . "\0" . 'Application_Model_Details' . "\0" . 'sequence', '' . "\0" . 'Application_Model_Details' . "\0" . 'text', '' . "\0" . 'Application_Model_Details' . "\0" . 'posts');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Application_Model_Details $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPosts(\Application_Model_Posts $posts)
    {
